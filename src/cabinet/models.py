...
class TeachingMaterial(AbstractMaterial):
    type = models.ForeignKey('cabinet.TeachingMaterialType', on_delete=models.SET_NULL)


class ScientificMaterial(AbstractMaterial):
    type = models.ForeignKey('cabinet.ScientificMaterialType', on_delete=models.SET_NULL)
